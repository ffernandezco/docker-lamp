...
<div class="container">
    ...
    <div class="card shadow p-4 mt-5">
        ...
        <?php if (isset($_SESSION['user_email'])): ?>
            <a href="/modify_user?user=<?php echo htmlspecialchars($_SESSION['id'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-secondary d-inline-flex align-items-center">Modificar datos de usuario</a>
